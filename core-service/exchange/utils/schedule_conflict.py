...
def is_conflict(a, b):
    ...
    start_a, end_a = to_time(a.get("start_time")), to_time(a.get("end_time"))
    start_b, end_b = to_time(b.get("start_time")), to_time(b.get("end_time"))
