...
class _TimeTableDeleteScreenState extends State<TimeTableDeleteScreen> {
  ...
  Future<void> _submitDelete() async {
    ...
    try {
      final success = await TimeTableService.deleteTimetable(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          ...
          style: TextStyle(
            ...
            fontSize: 22,
            color: Color(0xFF7A0E1D), // 삭제니까 약간 레드톤 강조
          ),
        ),
      ),
      body: Padding(
